...
const (
	InvoiceService_CreateAndSendInvoice_FullMethodName = "/invoice.InvoiceService/CreateAndSendInvoice"
)
...
type InvoiceServiceClient interface {
	CreateAndSendInvoice(ctx context.Context, in *CreateInvoiceRequest, opts ...grpc.CallOption) (*CreateInvoiceResponse, error)
}
...
func (c *invoiceServiceClient) CreateAndSendInvoice(ctx context.Context, in *CreateInvoiceRequest, opts ...grpc.CallOption) (*CreateInvoiceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateInvoiceResponse)
	err := c.cc.Invoke(ctx, InvoiceService_CreateAndSendInvoice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InvoiceServiceServer interface {
	CreateAndSendInvoice(context.Context, *CreateInvoiceRequest) (*CreateInvoiceResponse, error)
...
func (UnimplementedInvoiceServiceServer) CreateAndSendInvoice(context.Context, *CreateInvoiceRequest) (*CreateInvoiceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAndSendInvoice not implemented")
}
...
func _InvoiceService_CreateAndSendInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateInvoiceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InvoiceServiceServer).CreateAndSendInvoice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InvoiceService_CreateAndSendInvoice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InvoiceServiceServer).CreateAndSendInvoice(ctx, req.(*CreateInvoiceRequest))
	}
...
var InvoiceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateAndSendInvoice",
			Handler:    _InvoiceService_CreateAndSendInvoice_Handler,
		},
	},
